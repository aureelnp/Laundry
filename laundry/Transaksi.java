    ...
    public void prosesTransaksi(Client member, Transaksi transaksi, JenisLaundry barang){
        ...
        int temp=0;
            ...
            System.out.println("Jenis Laundry \tTotal\tHarga\tJumlah\t");
                ...
                int x = idBarang.size();
                for (int j = 0; j<x;j++){
                    //seumpama pada getjml berang itu ada 3 barang jadi x itu jumlah e barang 
                ...
                System.out.println("Sisa Saldo " +  member.getSaldo(idMember) + " = "+  member.getSaldo(idMember));
            }
            ...
            barang.editDurasi(idBarang, barang.getDurasi(idBarang)+1*banyaknya);
            }
